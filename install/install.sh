...
***********************************************
";
sudo apt install -y terminator gnome-tweak-tool qbittorrent dconf-editor curl wget tor git gimp vlc ssh gedit-plugins gufw tmux network-manager-openvpn openvpn network-manager-openvpn-gnome htop mlocate filezilla gparted ubuntu-restricted-extras ffmpeg fd-find jq stow xdg-utils ntpdate libevent-dev ncurses-dev build-essential bison pkg-config poppler-utils
